...
class loginprofileparent extends StatefulWidget {
  const loginprofileparent({super.key});

  @override
  State<loginprofileparent> createState() => loginprofileStateparent();
}

class loginprofileStateparent extends State<loginprofileparent> {
  dynamic size;
  double height = 0.00;
  double width = 0.00;
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    //           ? AppString.studentimageurl+photo.toString() // Replace with your student image URL
                    //           : AppString.staffimageurl+photo.toString(), // Replace with your staff image URL
                    //       width: 20,
                    //       height: 20,
                    //       )
                    //     : Image.asset(
                              ...
                              if (snapshot.connectionState == ConnectionState.done) {
                                if (snapshot.hasError || snapshot.data != true) {
                                  ...
                                  return Image.network(
                                     AppString.parentimageurl + photo.toString(),
                                    width: 20,
                                    height: 20,
                                  );
                                }
