...
import '../shivpeeth_teacher/shivpeeth_fullstudentfeedatashow.dart';
...
class studentfeereportState extends State<studentfeereport> {
  ...
  Future<void> fetchbuinesssearchlist(selectedValue, selectedValue2) async {
    ...
    final response = await http.post(
      ...
      body: {
        ...
        "section_id":
            selectedValue2 != null ? selectedValue2 : 'Select Section',
          ...
          children: [
            ...
            Column(
              children: [
                InkWell(
                  onTap: () {
                    fetchbuinesssearchlist(
                        selectedValueid, selectedValuesectionid);
                  },
                  child: Image.asset(
                    WireframePngimage
  ...
  void filterItems(String query) {
    ...
    setState(() {
      carouselItems =
          List.from(filteredList.isEmpty ? carouselItems : filteredList);
    });
  }
                                ...
                                Expanded(
                                  ...
                                  child: Container(
                                    margin: EdgeInsets.symmetric(
                                        horizontal:
                                            10.0), // Add horizontal margin
                                    height:
                                        50.0, // Set the height of the TextField
                      ...
                      Column(
                        children: [
                          InkWell(
                            ...
                            child: Image.asset(
                              WireframePngimage
                                  .excel, // Replace with your image asset path
                              width: 40,
                              height: 40,
                            ),
                          ),
                                            ...
                                            color: () {
                                              if (student.Dueamount == "0") {
                                                ...
                                                return WireframeColor
                                                    .red; // Change this to the color you want for unpaid
                                              } else {
                                                return WireframeColor
                                                    .bootomcolor;
                                              }
