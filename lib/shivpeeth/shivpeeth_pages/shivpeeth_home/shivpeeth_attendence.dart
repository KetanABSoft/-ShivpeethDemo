...
import 'package:messeges_with_firebase/shivpeeth/shivpeeth_pages/shivpeeth_home/shivpeeth_studentattendencereport.dart';
...
import '../shivpeeth_teacher/shivpeeth_teacheradd_attendance.dart';
...
class _WireframeattaendanceState extends State<Wireframeattendance> {
  ...
  void getshadpre() async {
    ...
    setState(() {
      ...
      if (roleid == '3') {
        if ((widget.classid.toString() == "null" &&
            widget.sectionid.toString() == "null")) {
          Getattendencedata("Select Class", "Select Section", DateTime.now());
        } else {
          Getattendencedata(
              widget.classid.toString(), widget.sectionid, DateTime.now());
        }
      }
  ...
  Getattendencedata(class_id, section_id, startdate) async {
    ...
    if (roleid == '7') {
      ...
      section_id = widget.sectionid;
        ...
        (widget.classid != 'null' && widget.sectionid != 'null')) {
      class_id = widget.classid;
      section_id = widget.sectionid;
    }
                        ...
                        child: Container(
                          ...
                          child: DropdownSearch<String>(
                            ...
                            onChanged: (String? value) {
                              if (value != null) {
                                int selectedIndex =
                                    sectiontypename.indexOf(value);
                                selectedIdsection =
                                    sectiontypeid[selectedIndex];
                                setState(() {
                            ...
                            selectedItem:
                                selectedValuesection ?? "Select Section",
                          ),
                        ),
                      ),
                    ],
              ...
              children: [
                InkWell(
                  onTap: () {
                    ...
                    Getattendencedata(
                        selectedValueid, selectedValuesectionid, selectdate);
                  },
                  child: Image.asset(
                    WireframePngimage
                        .filter, // Replace with your image asset path
                    width: 40,
                    height: 40,
                  ),
                ),
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  if (roletype == "3")
                    if (widget.classid != 'Select Class' &&
                        widget.sectionid != 'Select Section')
                      Container()
                    else
                  ...
                  TableCalendar(
                    ...
                    onDaySelected: (selectedDay, focusedDay) {
                      setState(() {
                        ...
                        Getattendencedata(selectedValueid,
                            selectedValuesectionid, selectdatedate);
                      });
                    },
